...
export const procesarOferta = (req, res) => {
    ...
    try {
        ...
        const { firma_valida, metadata, documento_buffer } = resultado;
        const estadoFinal = firma_valida ? 'VERIFICADA Y VÁLIDA' : 'INVÁLIDA';
        
        // Guardar el documento original desencriptado
        const rutaDesencriptada = path.join(DIR_DESENCRIPTADAS, `desenc_${filename}.pdf`);
